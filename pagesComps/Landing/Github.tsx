export default function Github() {
    return (
        <div className="fixed z-50 top-0 right-0 py-4 px-8 bg-gray-900 rounded-full">
            <a
                className="group flex items-center space-x-3 text-gray-600 hover:text-gray-200 focus:text-gray-200 transition-colors duration-300"
